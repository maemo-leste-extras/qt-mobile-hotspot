...
HEADERS += src/macinputdialog.h src/ui_macinputdialog.h
...
SOURCES += src/plugin.cpp	src/pluginconfiguration.cpp	src/plugingui.cpp	src/macinputdialog.cpp

# Forms (.ui)
# You should not have to put anything from qtMobileHotspot here
FORMS =	src/plugingui.ui	src/macinputdialog.ui
