...
HEADERS += src/plugin.h	src/pluginconfiguration.h	src/plugingui.h	src/ui_plugingui.h	src/dnsmasqhelper.h	src/dnsdialog.h	src/ui_dnsdialog.h
HEADERS += src/dnstabledialog.h	src/ui_dnstabledialog.h	src/dhcptabledialog.h	src/ui_dhcptabledialog.h	src/ui_dhcpdialog.h	src/dhcpdialog.h
...
SOURCES += src/plugin.cpp	src/pluginconfiguration.cpp	src/plugingui.cpp	src/dnsmasqhelper.cpp	src/dnsdialog.cpp
SOURCES += src/dnstabledialog.cpp	src/dhcptabledialog.cpp	src/dhcpdialog.cpp

# Forms (.ui)
# You should not have to put anything from qtMobileHotspot here
FORMS =	src/plugingui.ui	src/dnsdialog.ui	src/dnstabledialog.ui	src/dhcptabledialog.ui	src/dhcpdialog.ui

# Translations (.ts)
# Should be called lib$$TARGET-lang.ts (ex : libqtmhdummy-fr.ts)
