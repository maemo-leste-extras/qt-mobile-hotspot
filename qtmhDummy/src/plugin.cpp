...
QString Plugin::name(){
	return "org.your_name.qtmh.please_rename_me"; // unique name of the plugin, wont be displayed
}

QString Plugin::displayedName(){
	return tr("Please rename me"); // displayed name in the plugins control window
}

QString Plugin::displayedAuthor(){
	return "your_name"; // displayed author name in the plugins control window
}

QString Plugin::displayedContact(){
	return "your_email"; // displayed contact-info in the plugins control window
}

QString Plugin::displayedDescription(){
	QString desc = tr("Enter here your description.") + "\n";
	desc += tr("It can be using more than 1 line.");
